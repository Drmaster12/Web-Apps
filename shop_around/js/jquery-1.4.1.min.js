(function(z, v) {
        ...
        function na(a) {
            var b, d = [],
                f = [],
                e = arguments,
                i, j, n, o, m, s, x = c.extend({}, c.data(this, "events")
                    .live);
                ...
                for (s = i.length; m < s; m++)
                    for (o in x) {
                        ...
                        if (i[m].selector === j.selector) {
                            if (j.live === "mouseenter" || j.live === "mouseleave") f = c(a.relatedTarget)
                                .closest(j.selector)[0];
                            if (!f || f !== n) d.push({
                                elem: n,
                                fn: j
                            })
        ...
        c.fn = c.prototype = {
            ...
            slice: function() {
                return this.pushStack(Q.apply(this, arguments), "slice", Q.call(arguments)
                    .join(","))
            },
            map: function(a) {
        ...
        c.extend({
            ...
            parseJSON: function(a) {
                ...
                if (/^[\],:{}\s]*$/.test(a.replace(/\\(?:["\\\/bfnrt]|u[0-9a-fA-F]{4})/g, "@")
                        ...
                        .replace(/(?:^|:|,)(?:\s*\[)+/g, ""))) return z.JSON && z.JSON.parse ? z.JSON.parse(a) : (new Function("return " + a))();
        ...
        (function() {
            ...
            if (!(!e || !e.length || !i)) {
                c.support = {
                    ...
                    optSelected: r.createElement("select")
                ...
                c.support.checkClone = a.cloneNode(true)
                    .cloneNode(true)
                    .lastChild.checked;
                c(function() {
        ...
        c.fn.extend({
            data: function(a, b) {
                ...
                } else return this.trigger("setData" + d[1] + "!", [d[0], b])
                    .each(function() {
                        c.data(this, a, b)
                    })
            },
        ...
        c.fn.extend({
            ...
            addClass: function(a) {
                ...
                if (a && typeof a === "string")
                    for (var b = (a || "")
                            .split(ca), d = 0, f = this.length; d < f; d++) {
                        var e = this[d];
                        if (e.nodeType === 1)
                            if (e.className)
                        ...
                        if (e.nodeType === 1 && e.className)
                            if (a) {
                                for (var i = (" " + e.className + " ")
                                        .replace(ya, " "), j = 0, n = b.length; j < n; j++) i = i.replace(" " + b[j] + " ", " ");
            ...
            setup: function(a, b, d) {
                if (this.nodeName.toLowerCase() !==
                    ...
                    c.event.add(this, "click.specialSubmit." + d.guid, function(f) {
                        var e = f.target,
                            i = e.type;
                        if ((i === "submit" || i === "image") && c(e)
                            .closest("form")
                            .length) return ma("submit", this, arguments)
                    });
                    c.event.add(this, "keypress.specialSubmit." + d.guid, function(f) {
                        var e = f.target,
                            i = e.type;
                        if ((i === "text" || i === "password") && c(e)
                            .closest("form")
                            .length && f.keyCode === 13) return ma("submit", this, arguments)
                    })
                } else return false
            },
            remove: function(a, b) {
        ...
        c.each(["live", "die"], function(a, b) {
            c.fn[b] = function(d, f, e) {
                ...
                for (d = (d || "")
                    ...
                    b === "live" ? c(this.context)
                        .bind(oa(i, this.selector), {
                            data: f,
                            selector: this.selector,
                            live: i
                        }, e) : c(this.context)
                        .unbind(oa(i, this.selector), e ? {
        ...
        (function() {
            ...
            var m = o.selectors = {
                    ...
                    preFilter: {
                        CLASS: function(g, h, k, l, q, p) {
                            ...
                            for (var u;
                                (u = h[p]) != null; p++)
                                if (u)
                                    if (q ^ (u.className && (" " + u.className + " ")
                                            .replace(/[\t\n]/g, " ")
                                            .indexOf(g) >= 0)) k || l.push(u);
                                    else if (k) h[p] = false;
                            return false
                        },
                        ID: function(g) {
                        ...
                        PSEUDO: function(g, h, k, l, q) {
                            if (g[1] === "not")
                                if ((f.exec(g[3]) || "")
                                    .length > 1 || /^\w/.test(g[3])) g[3] = o(g[3], null, null, h);
                                else {
                    ...
                    filter: {
                        ...
                        ATTR: function(g, h) {
                            ...
                            var l = h[2];
                            h = h[4];
                            return g == null ? l === "!=" : l === "=" ? k === h : l === "*=" ? k.indexOf(h) >= 0 : l === "~=" ? (" " + k + " ")
                                .indexOf(h) >= 0 : !h ? k && g !== false : l === "!=" ? k !== h : l === "^=" ?
            ...
            (function() {
                ...
                if (r.getElementById(h)) {
                    m.find.ID = function(l, q, p) {
                        if (typeof q.getElementById !== "undefined" && !p) return (q = q.getElementById(l[1])) ? q.id === l[1] || typeof q.getAttributeNode !== "undefined" && q.getAttributeNode("id")
                            .nodeValue === l[1] ? [q] : v : []
                    };
            ...
            (function() {
                ...
                if (g.getElementsByTagName("*")
                    .length > 0) m.find.TAG = function(h, k) {
            ...
            (function() {
                ...
                if (!(!g.getElementsByClassName || g.getElementsByClassName("e")
                        .length ===
                        0)) {
                    g.lastChild.className = "e";
                    if (g.getElementsByClassName("e")
                        .length !== 1) {
            ...
            var E = r.compareDocumentPosition ? function(g, h) {
                ...
                w = function(g) {
                    return (g = (g ? g.ownerDocument || g : 0)
                        .documentElement) ? g.nodeName !== "HTML" : false
                },
                fa = function(g, h) {
                    var k = [],
                        l = "",
        ...
        c.fn.extend({
            ...
            index: function(a) {
                if (!a || typeof a === "string") return c.inArray(this[0], a ? c(a) : this.parent()
                    .children());
        ...
        c.each({
            ...
            c.fn[a] = function(d, f) {
                ...
                return this.pushStack(e, a, Q.call(arguments)
                    .join(","))
            }
        });
        c.extend({
            ...
            dir: function(a, b, d) {
                var f = [];
                for (a = a[b]; a && a.nodeType !== 9 && (d === v || a.nodeType !== 1 || !c(a)
                        .is(d));) {
        ...
        c.fn.extend({
            text: function(a) {
                ...
                if (typeof a !== "object" && a !== v) return this.empty()
        ...
        c.each({
            ...
            c.fn[a] = function(d) {
                ...
                for (var e = 0, i = d.length; e < i; e++) {
                    var j = (e > 0 ? this.clone(true) : this)
                        .get();
            ...
            load: function(a, b, d) {
                ...
                c.ajax({
                    ...
                    complete: function(j, n) {
                        if (n === "success" || n === "notmodified") i.html(e ? c("<div />")
                            .append(j.responseText.replace(qb, ""))
                            .find(e) : j.responseText);
        ...
        c.extend({
            ...
            handleError: function(a, b, d, f) {
                ...
                if (a.global)(a.context ? c(a.context) : c.event)
        ...
        c.each(["Left", "Top"], function(a, b) {
            ...
            c.fn[d] = function(f) {
                ...
                if (f !== v) return this.each(function() {
                    if (i = ua(this)) i.scrollTo(!a ? f : c(i)
                        .scrollLeft(), a ? f : c(i)
                        .scrollTop());
                    else this[d] = f
                });
        ...
        c.each(["Height", "Width"], function(a, b) {
                    ...
                    c.fn[d] = function(f) {
                            ...
                            return "scrollTo" in e && e.document ? e.document.compatMode === "CSS1Compat" && e.document.documentElement["client" + b] ||
                                e.document.body["client" + b] : e.nodeType === 9 ? Math

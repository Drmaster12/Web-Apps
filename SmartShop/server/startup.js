Meteor.startup(function(){
    if(Products.find().count() === 0){
      ...
      Products.insert({thumb:'blackberrysmoothie.jpeg',name:'Blackberry Smoothie',desc:'Luscious Blackbery Smoothie',price:2.50,catName:'Fruity'});
       Products.insert({thumb:'candy.png',name:'Candy',desc:'Candy',price:1.50,catName:'Sweet'});
      Products.insert({thumb:'donuts.png',name:'Donuts',desc:'Donuts',price:2.50,catName:'Sweet'});
